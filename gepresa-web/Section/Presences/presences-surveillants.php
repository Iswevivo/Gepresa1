      ...
      <div class="row m-3">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-12 col-lg-offset-5 px-4 m-5">
          <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h3>FICHE DES PRESENCES DES SURVEILLANTS</h3>
          ...
          <div>
            <table id="data" class="table table-bordered datatable responsive m-3">
              <thead class="bg-primary">
                <tr>
                  <th scope="col">N°</th>
                  <th scope="col">Grade et noms du surveillant</th>
              ...
              <tbody>
                ...
                foreach ($surveillances as $surveillance) : $i++; ?>
                    <tr>
                      ...
                      <td><?= $surveillance['nomSalle'] ?> </td>
                      <td><?= $surveillance['vacation'] ?> </td>
                      <td><?= $surveillance['timeIn'] ?> </td>
                      <td><?= $surveillance['timeOut'] ?> </td>
                      <td><?php 
                            if($surveillance['timeOut'] === '00:00:00' && $surveillance['timeIn'] === '00:00:00' && $surveillance['dateSurveillance'] >= date('Y-m-d')){
                                echo "RAS";
                            }elseif($surveillance['timeOut'] === '00:00:00' && $surveillance['timeIn'] === '00:00:00' && $surveillance['dateSurveillance'] < date("Y-m-d")){
                                echo "Absent";
                            }elseif($surveillance['timeOut'] === '00:00:00' && $surveillance['timeIn'] !== '00:00:00' && $surveillance['dateSurveillance'] == date("Y-m-d")){
                                echo "-";
                            }elseif(($surveillance['timeOut'] === '00:00:00' || $surveillance['timeIn'] === '00:00:00') &&  $surveillance['dateSurveillance'] < date("Y-m-d")){
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel" class="text-primary text-center">POINTER UNE PRESENCE --Surveillant</h5>
          ...
          <div class="modal-body" id="show_data">
            <form action="" class="row" method="post" id="addform">
              <h5 id="blink" class="text-center">Scannez votre carte pour pointer la présence</h5>
              <p id="cardUID"></p>
              <div class="form-group">
                <table class="table mt-3  table-bordered">
                  <tr class="p-3">
                    <td class="bg-primary text-white text-center"> <strong>Informations du surveillant</strong></td>
                  </tr>
                  <tr>
                    <td>
                      <table class="table table-striped">
                        <tr>
                          <td width="113" class="lf">Card ID</td>
                          <td class="fw-bold">:</td>
                          <td align="left">--------</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td width="113" class="lf">Grade</td>
                          <td class="fw-bold">:</td>
                          <td align="left">--------</td>
                        </tr>
                        <tr>
                          <td width="113" class="lf">Sexe</td>
                          <td class="fw-bold">:</td>
                ...
                <div class="modal-footer mt-3">
                  ...
                  <button type="submit" class="btn btn-outline-info">
                    <span class="bi bi-arrow-left"> RETOUR</span>
                  </button>
                </div>
            </form>
...
<script>
			...
			function showUser(str) {
				if (str == "") {
					...
					xmlhttp.open("GET","get_data.php?UID="+str,true);
					xmlhttp.send();
				}
			}
